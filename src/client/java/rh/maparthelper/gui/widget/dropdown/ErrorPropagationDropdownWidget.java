...
public class ErrorPropagationDropdownWidget extends ImageAdjustmentsDropdownWidget {
    ...
    public ErrorPropagationDropdownWidget(@NotNull Screen screen, MapartProcessing mapart, int width, int height,
